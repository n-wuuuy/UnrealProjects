...
void EmptyLinkFunctionForGeneratedCodeStoryGame_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_StoryGame()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_StoryGame_HealthsEndedEvent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_StoryGame_HealthsChangedEvent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_StoryGame_HealthEndedEvent__DelegateSignature,
				(UObject* (*)())Z_Construct_UDelegateFunction_StoryGame_PawnDamagedEvent__DelegateSignature,
			};
